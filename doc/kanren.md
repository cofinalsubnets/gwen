...
Companions: `love/kanren.l` (the module), `test/kanren.l` (the gate), `doc/proto/kanren-prove.l`
(the proof producer), `crew/sat/kanren-count.l` (#SAT out of the ring), `doc/proto/datalog.l`
...
* **search — not free.** A binder whose body is still a logic variable is not yet a function, so
  ...
  alpha-equivalence of answers. `doc/proto/kanren-prove.l` does exactly this (`mintname`), and its
