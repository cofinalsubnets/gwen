...
crew/source/source.l six bindings left the form (`src-head src-lay-tgz src-lay-love src-lay
...
```sh
LOVE_NO_GLAZE=1 love -l probe.l -l lib/gz.l -l lib/tar.l -l crew/source/source.l \
