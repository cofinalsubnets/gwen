...
# with it -- which is the seed verb's own fallback spelled by hand (lib/source.l names
...
# (lib/source.l) supplies make/sh/sed and the rest out of the binary itself.
