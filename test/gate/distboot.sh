...
# with it -- which is the seed verb's own fallback spelled by hand (crew/source/source.l names
...
# (crew/source/source.l) supplies make/sh/sed and the rest out of the binary itself.
