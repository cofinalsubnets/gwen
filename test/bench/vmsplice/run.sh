...
# Run from the repo root: sh test/bench/vmsplice/run.sh
#
# Two halves:
...
if command -v $CC >/dev/null 2>&1; then
  ...
  $CC -O2 -std=c2x -I. -Iout/lib -c test/bench/vmsplice/splice.c -o $o/splice-cc.o
...
$mc -I. -Iout/lib -c test/bench/vmsplice/splice.c $o/splice-mc.o
...
$mc -I. -Iout/lib -c test/bench/vmsplice/body.c $o/body.o
$m test/bench/vmsplice/lift.l $o/body.o jitbody $o/jitcode.l
echo "-- glaze on (the specializing tier is the baseline) --"
$m -l $o/jitcode.l test/bench/vmsplice/install.l
echo "-- glaze off (the true interpreter baseline) --"
LOVE_NO_GLAZE=1 $m -l $o/jitcode.l test/bench/vmsplice/install.l
