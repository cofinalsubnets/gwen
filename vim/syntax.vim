...
syn keyword LoveBook herald hot? id? im in inf inf-spine inf-sym
...
syn keyword LoveBook kp1 kp2 krefl kseq ksucc landed? last link
...
syn keyword LoveBook memfd merge min mint mintp mkdir modpow monofix
...
syn keyword LoveBook peepw pin pinw pipe please pmap port? pour
...
syn keyword LoveBook revcat rewrite ring rmdir rng-box rng-get rng-set runp
syn keyword LoveBook sX s_plus s_star sat saturate say scare scare?
syn keyword LoveBook scoop screen scribe seal see seq seqs setenv
