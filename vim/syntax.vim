...
syn keyword LoveBook edln edlnc edraw empty? environ eof? eps err
syn keyword LoveBook est ev exec ext_s fdclose fdopen filter fired?
syn keyword LoveBook fires fixity flip flush foldl foldl1 foldr foldr1
...
syn keyword LoveBook getenv getpid getuid glass glaze hardlink has-top-op? has_s
...
syn keyword LoveBook modpow monofix monoid more? mount name? names natjit
syn keyword LoveBook nclock negate net newns nil? nom nom? num-ap
syn keyword LoveBook one one? op-span open openfd opfix opt out
syn keyword LoveBook outer ov-check ov-eng ov-hook ov-slot overlay overlay-off overlay-set
syn keyword LoveBook p1-all? p1-atom p1-chars p1-dec-int? p1-dig? p1-digits p1-dval p1-eol
syn keyword LoveBook p1-esc p1-glued? p1-hex-int? p1-hex? p1-in? p1-int p1-lift p1-list
syn keyword LoveBook p1-low p1-oct-int? p1-oct? p1-op p1-opc? p1-read1 p1-reads p1-rev
syn keyword LoveBook p1-run p1-skip p1-splice? p1-str p1-tend? p1-text p1-tok p1-wrap
syn keyword LoveBook p1-ws? parse part peep peepw pin pinw pipe
syn keyword LoveBook please pmap pour powover print prod ptyecho pull
syn keyword LoveBook put putbn putc putn puts putx q qlit
syn keyword LoveBook query quit rand randf random rank raw re
syn keyword LoveBook read readdir readlink reads reciprocal rejects rel rename
syn keyword LoveBook reply rest rev revcat rewrite ring rmdir rng-box
syn keyword LoveBook rng-get rng-set run runp runt sX s_plus s_star
syn keyword LoveBook sat saturate say scare scare? screen scribe seal
syn keyword LoveBook see seq seqs setenv setwinsize sfold sha256 shape
syn keyword LoveBook shell shore show sigfd signal sigtake sine sip
syn keyword LoveBook skip slist slurp smap snip sno sort sortby
syn keyword LoveBook sound sound0 span spawn spawnio spawnmap spread stack
...
syn keyword LoveBook tangent tap tier top-tray tray? ttyfg turn turnf
