...
syn keyword LoveBook chug clock close co coin coin? compose conj
...
syn keyword LoveBook dot dour drop dup dup2 each edln edlnc
...
syn keyword LoveBook krefl kseq ksucc landed? last link listen lit?
syn keyword LoveBook load lof log lseek macro-names map mapfd mapfdo
syn keyword LoveBook mapin mapout max member? memfd merge min mint
syn keyword LoveBook mintp mkdir modpow monofix monoid mount name? names
syn keyword LoveBook natjit nclock negate net newns nil? nom nom?
syn keyword LoveBook num-ap once one? open openfd opfix out outer
syn keyword LoveBook ov-check ov-eng ov-hook ov-slot overlay overlay-off overlay-set part
syn keyword LoveBook peep peepw pin pinw pipe please port? pour
...
syn keyword LoveBook s_plus s_star sat saturate say scare scare? scoop
syn keyword LoveBook screen scribe seal see setenv setwinsize sfold sha256
syn keyword LoveBook shape shell shore show sigfd signal sigtake sine
syn keyword LoveBook slist slurp smap snip sno sort sortby sound
syn keyword LoveBook sound0 spawn spawnio spawnmap spread stack stake star-tray
