...
syn keyword LoveBook getuid glass glaze hardlink has-top-op? has_s hear help
...
syn keyword LoveBook kp2 krefl kseq ksucc last link listen lit
syn keyword LoveBook lit? load lof log lseek macro-names many map
syn keyword LoveBook mapfd mapfdo mapin mapout max member? memfd merge
syn keyword LoveBook min mind mint mintp missing mkdir modpow monofix
syn keyword LoveBook monoid more? mount name? names natjit nclock negate
syn keyword LoveBook net newns nil? nom nom? num-ap one one?
syn keyword LoveBook op-span open openfd opfix opt out outer ov-check
...
syn keyword LoveBook top-tray tray? ttyfg turn turnf twin twin-tray twin?
syn keyword LoveBook twirl two? u2 u2app udp-bind udp-recv udp-send ufail?
syn keyword LoveBook uglo umask unfold unify unlink unmap unsee use
...
syn keyword LoveBook winsize wl-recv wl-send wrap zero? zip
