...
syn keyword LoveBook mint mint? mintp mkdir modpow monofix monoid mount
syn keyword LoveBook name name? names natjit nclock negate net newns
syn keyword LoveBook nil? nom nom? num-ap once one? open openfd
syn keyword LoveBook opfix out outer ov-check ov-eng ov-hook ov-slot overlay
syn keyword LoveBook overlay-off overlay-set part peep peepw pin pinw pipe
syn keyword LoveBook please port? pour powover print prod ptyecho pull
...
syn keyword LoveBook rng-get rng-set sX s_plus s_star sat saturate say
...
syn keyword LoveBook sigtake sine slist slurp smap snip sno sort
...
syn keyword LoveBook tangent tap tether tier top-tray trap tray? trickle
