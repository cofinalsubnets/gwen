...
syn keyword LoveBook glaze glean gulp hardlink hark has_s hear heard
...
syn keyword LoveBook listen lit? load lof log lseek macro-names map
syn keyword LoveBook mapfd mapfdo mapin mapout max member? memfd merge
syn keyword LoveBook min mint mintp mkdir modpow monofix monoid mount
syn keyword LoveBook name? names natjit nclock negate net newns nil?
syn keyword LoveBook nom nom? num-ap once one? open openfd opfix
syn keyword LoveBook out outer ov-check ov-eng ov-hook ov-slot overlay overlay-off
syn keyword LoveBook overlay-set part peep peepw pin pinw pipe please
...
syn keyword LoveBook rng-set sX s_plus s_star sat saturate say scare
