...
syn keyword LoveBook getpid getuid glass glaze hardlink has_s hear help
...
syn keyword LoveBook monoid mount name? names natjit nclock negate net
syn keyword LoveBook newns nil? nom nom? num-ap one one? open
syn keyword LoveBook openfd opfix opt out outer ov-check ov-eng ov-hook
syn keyword LoveBook ov-slot overlay overlay-off overlay-set parse part peep peepw
syn keyword LoveBook pin pinw pipe please pmap pour powover print
syn keyword LoveBook prod ptyecho pull put putbn putc putn puts
syn keyword LoveBook putx q qlit query quit rand randf random
...
syn keyword LoveBook ring rmdir rng-box rng-get rng-set run runp runt
syn keyword LoveBook sX s_plus s_star sat saturate say scare scare?
syn keyword LoveBook screen scribe seal see seq seqs setenv setwinsize
syn keyword LoveBook sfold sha256 shape shell shore show sigfd signal
syn keyword LoveBook sigtake sine sip skip slist slurp smap snip
syn keyword LoveBook sno sort sortby sound sound0 span spawn spawnio
