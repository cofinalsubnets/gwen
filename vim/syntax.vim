...
syn keyword LoveBook sine slist slurp smap snip sno sort sortby
syn keyword LoveBook sound sound0 spawn spawnio spawnmap spread stack stake
syn keyword LoveBook star-tray star? stat still string string? subst sun
syn keyword LoveBook sun? swig symlink tablet tablet? take tally tangent
syn keyword LoveBook tap tether tier top-tray tray? trickle ttyfg turn
syn keyword LoveBook turnf twin twin-tray twin? twirl two? u2 u2app
syn keyword LoveBook udp-bind udp-recv udp-send ufail? uglo umask unfold unify
syn keyword LoveBook unlink unmap unsee use utime uu uu2l vapp
syn keyword LoveBook var var? vof vof-spine vof-sym vsucc wait walk
syn keyword LoveBook welp wet wheel whole? winsize wl-recv wl-send wrap
syn keyword LoveBook zero? zip
