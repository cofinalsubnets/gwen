...
syn keyword LoveBook edln edlnc edraw environ eps err est ev
syn keyword LoveBook exec ext_s fdclose fdopen filter fired? fires fixity
syn keyword LoveBook flip flow flush foldl foldl1 foldr foldr1 font
syn keyword LoveBook fork forms fraction freeze from g-die galaxy? gather
syn keyword LoveBook gauge gaze gcd gem gem-tray gem? getc getenv
syn keyword LoveBook getpid getuid glass glaze gulp hardlink has_s hear
syn keyword LoveBook help hot? id? im in inf inf-spine inf-sym
syn keyword LoveBook init inner int intern ioctl iota jot jug
syn keyword LoveBook kbrec kchain kconst kcrec keys ki1 ki2 knrec
syn keyword LoveBook kp1 kp2 krefl kseq ksucc last link listen
syn keyword LoveBook lit lit? load lof log lseek macro-names many
...
syn keyword LoveBook monofix monoid mount name? names natjit nclock negate
syn keyword LoveBook net newns nil? nom nom? num-ap once one
syn keyword LoveBook one? open openfd opfix opt out outer ov-check
syn keyword LoveBook ov-eng ov-hook ov-slot overlay overlay-off overlay-set parse part
syn keyword LoveBook peep peepw pin pinw pipe please pmap pour
syn keyword LoveBook powover print prod ptyecho pull put putbn putc
syn keyword LoveBook putn puts putx q qlit query quit rand
...
syn keyword LoveBook revcat rewrite ring rmdir rng-box rng-get rng-set run
syn keyword LoveBook runp runt sX s_plus s_star sat saturate say
syn keyword LoveBook scare scare? screen scribe seal see seq seqs
syn keyword LoveBook setenv setwinsize sfold sha256 shape shell shore show
syn keyword LoveBook sigfd signal sigtake sine sip skip slist slurp
syn keyword LoveBook smap snip sno sort sortby sound sound0 span
...
syn keyword LoveBook symlink tablet tablet? take tally tangent tap tier
syn keyword LoveBook top-tray tray? trickle ttyfg turn turnf twin twin-tray
