...
syn keyword LoveBook getpid getuid glass glaze glean gulp hardlink hark
syn keyword LoveBook has_s help herald hot? id? im in inf
...
syn keyword LoveBook ki2 knrec kp1 kp2 krefl kseq ksucc last
syn keyword LoveBook link listen lit lit? load lof log lseek
syn keyword LoveBook macro-names many map mapfd mapfdo mapin mapout max
syn keyword LoveBook member? memfd merge min mint mintp missing mkdir
...
syn keyword LoveBook runp sX s_plus s_star sat saturate say scare
