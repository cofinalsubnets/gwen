...
syn keyword LoveBook getpid getuid glass glaze glean gulp hardlink has_s
...
syn keyword LoveBook merge min mint mintp missing mkdir modpow monofix
syn keyword LoveBook monoid mount name? names natjit nclock negate net
syn keyword LoveBook newns nil? nom nom? num-ap once one one?
...
syn keyword LoveBook tablet tablet? take tally tangent tap tether tier
